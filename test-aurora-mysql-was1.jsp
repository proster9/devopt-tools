...
<html>
<body>
<h1>Through WAS-1 Server with Aurora MySQL Database</h1>
<% 
      ...
      try { 
              ...
              out.println("WAS1-Database Connecting Started.<br>");

              Class.forName("com.mysql.cj.jdbc.Driver");
              out.println("WAS1-Database Connecting Waiting~<br>");

              conn = DriverManager.getConnection(Url, Id, Pass);              
              out.println("WAS1-Database Connect Success!<br>");
